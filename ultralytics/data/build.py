...
class _RepeatSampler:
    ...
    Attributes:
        sampler (datasets.sampler): The sampler to repeat.
    """
...
class ContiguousDistributedSampler(torch.utils.data.Sampler):
    ...
    Args:
        dataset (Dataset): datasets to sample from. Must implement __len__.
...
def build_dataloader(
    ...
    Args:
        dataset (Dataset): datasets to load data from.
