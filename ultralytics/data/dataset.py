...
class YOLODataset(BaseDataset):
    """datasets class for loading object detection and/or segmentation labels in YOLO format.
    ...
    Attributes:
        ...
        data (dict): datasets configuration dictionary.
    ...
    def __init__(self, *args, data: dict | None = None, task: str = "detect", **kwargs):
        ...
        Args:
            data (dict, optional): datasets configuration dictionary.
...
class YOLOMultiModalDataset(YOLODataset):
    """datasets class for loading object detection and/or segmentation labels in YOLO format with multi-modal support.
...
class GroundingDataset(YOLODataset):
    """datasets class for object detection tasks using annotations from a JSON file in grounding format.
...
class YOLOConcatDataset(ConcatDataset):
    """datasets as a concatenation of multiple datasets.
...
class ClassificationDataset:
    """datasets class for image classification tasks extending torchvision ImageFolder functionality.
