...
class YOLOETrainer(DetectionTrainer):
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (datasets): YOLO dataset configured for training or validation.
        """
...
class YOLOETrainerFromScratch(YOLOETrainer, WorldTrainerFromScratch):
    ...
    def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
        """Build YOLO datasets for training or validation.
        ...
        Returns:
            (YOLOConcatDataset | datasets): The constructed dataset for training or validation.
        """
...
class YOLOEPEFreeTrainer(YOLOEPETrainer, YOLOETrainerFromScratch):
    ...
    def set_text_embeddings(self, datasets, batch: int):
        ...
        Args:
            datasets (list[datasets]): List of datasets containing category names to process.
...
class YOLOEVPTrainer(YOLOETrainerFromScratch):
    ...
    def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
        """Build YOLO datasets for training or validation with visual prompts.
        ...
        Returns:
            (datasets): YOLO dataset configured for training or validation, with visual prompts for training mode.
        """
