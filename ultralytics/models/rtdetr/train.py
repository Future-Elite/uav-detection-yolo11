...
class RTDETRTrainer(DetectionTrainer):
    ...
    Attributes:
        ...
        data (dict): datasets configuration containing class count and other parameters.
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None):
        ...
        Args:
            ...
            mode (str): datasets mode, either 'train' or 'val'.
            batch (int, optional): Batch size for rectangle training.

        Returns:
            (RTDETRDataset): datasets object for the specific mode.
        """
